...
desc cliente;
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
insert into cliente(nome, cpf, email, telefone, sexo, endereco) values('Joao', 988638273, 'joao@gmail.com', '22923110','M', 'Maia Lacerda - Estacio - Rio de Janeiro - RJ');
insert into cliente(nome, cpf, email, telefone, sexo, endereco) values('Celia', 541521456, 'celia@gmail.com', '25078869','F', 'Riachuelo - Centro - Rio de Janeiro - RJ');
insert into cliente(nome, cpf, email, telefone, sexo, endereco) values('Jorge', 885755896, 'jorge@gmail.com', '58748895','M', 'Oscar Cury - Bom Retiro - Rio de Janeiro - RJ');
insert into cliente(nome, cpf, email, telefone, sexo, endereco) values('Ana', 765432896, 'ana@globo.com', '54548895','F', 'Pres Antonio Carlos - São Paulo - SP');
insert into cliente(nome, cpf, email, telefone, sexo, endereco) values('Carla', 234266396, 'carla@terati.com.br','42595','F', 'Samuel Silva - Centro - Belo Horizonte - MG');
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
count junto com o group by;
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------------
insert into telefone (tipo, numero, id_cliente) values ('cel', '9955331', 1);
insert into telefone (tipo, numero, id_cliente) values ('com', '8745473', 1);
insert into telefone (tipo, numero, id_cliente) values ('cel', '9954444', 2);
insert into telefone (tipo, numero, id_cliente) values ('cel', '9958987', 2);
insert into telefone (tipo, numero, id_cliente) values ('com', '9955875', 3);
insert into telefone (tipo, numero, id_cliente) values ('res', '4356551', 3);
insert into telefone (tipo, numero, id_cliente) values ('cel', '9456651', 6);
insert into telefone (tipo, numero, id_cliente) values ('cel', '9453331', 6);
insert into telefone (tipo, numero, id_cliente) values ('res', '4357671', 1);
insert into telefone (tipo, numero, id_cliente) values ('cel', '0987687', 2);
insert into telefone (tipo, numero, id_cliente) values ('cel', '7865644', 3);
insert into telefone (tipo, numero, id_cliente) values ('res', '5754644', 6);

insert into cliente (nome, sexo, email, cpf) values ('Joao','M','joao@ig.com','98547-6');
insert into cliente (nome, sexo, email, cpf) values ('Carlos', 'M', 'carlos@terra.com', '86664-7');
insert into cliente (nome, sexo, email, cpf) values ('Ana', 'F', 'ana@globo.com', '75658-5');
insert into cliente (nome, sexo, email, cpf) values ('Jorge', 'M', 'jorge@ig.com', '88657-5');
insert into cliente (nome, sexo, email, cpf) values ('Clara', 'F', null, '99754-7');
insert into cliente (nome, sexo, email, cpf) values ('Celia', 'F', 'joao@terra.com', '77558-5');

insert into endereco (rua, bairro, cidade, estado, id_cliente) values ('rua A', 'Centro', 'B.Horizonte', 'MG', 4);
insert into endereco (rua, bairro, cidade, estado, id_cliente) values ('rua B', 'Centro', 'Rio de Janeiro', 'RJ', 3);
insert into endereco (rua, bairro, cidade, estado, id_cliente) values ('rua C', 'Jardins', 'Sao Paulo', 'SP', 1);
insert into endereco (rua, bairro, cidade, estado, id_cliente) values ('rua B', 'Estacio', 'Rio de Janeiro', 'RJ', 2);
insert into endereco (rua, bairro, cidade, estado, id_cliente) values ('rua Z', 'Cruzeiro', 'B.Horizonte', 'MG', 6);
insert into endereco (rua, bairro, cidade, estado, id_cliente) values ('rua X', 'Flamengo', 'Rio de janeiro', 'RJ', 5);
insert into endereco (rua, bairro, cidade, estado, id_cliente) values ('rua U', 'Centro', 'Niteroi', 'RJ', 6);

----------------------------------------------------------------------------------------------------------------------------------------------------------

---------------------------------------------------------------------------------------------------------------------------------------
select idcliente, nome, sexo, rua, bairro, cidade, estado 
from cliente inner join endereco on idcliente = id_cliente;

select cliente.nome, cliente.sexo, endereco.rua, endereco.bairro, endereco.cidade, endereco.estado, telefone.tipo, telefone.numero 
from cliente inner join endereco on cliente.idcliente = endereco.id_cliente 
inner join telefone on cliente.idcliente = telefone.id_cliente where sexo = 'F';
...
insert into marcas (marca) values ('Pegeot');
insert into marcas (marca) values ('Hinday');
...
insert into cores (cor) values ('Verde');
insert into cores (cor) values ('Preto');
insert into cores (cor) values ('Branco');
insert into cores (cor) values ('Rosa');
insert into cores (cor) values ('Laranja');

insert into carros (carro,placa,id_marca) values ('Uno','JBE1234',2);
insert into carros (carro,placa,id_marca) values ('Celta','CWA4256',4);
insert into carros (carro,placa,id_marca) values ('Onix','FHY4910',4);
insert into carros (carro,placa,id_marca) values ('Corolla','JFP5072',8);
insert into carros (carro,placa,id_marca) values ('Sandero','WRS1864',5);
insert into carros (carro,placa,id_marca) values ('L200','FHC1956',10);
insert into carros (carro,placa,id_marca) values ('Fiesta','QTR3274',1);
insert into carros (carro,placa,id_marca) values ('307','LBE2356',6);
insert into carros (carro,placa,id_marca) values ('Gol','KMJ1000',3);
insert into carros (carro,placa,id_marca) values ('HB20','ECW3244',7);

insert into clientes (nome,sexo,id_carro) values ('Mario','M',5);
insert into clientes (nome,sexo,id_carro) values ('Marlon','M',3);
insert into clientes (nome,sexo,id_carro) values ('Maria','F',1);
insert into clientes (nome,sexo,id_carro) values ('Marcio','M',10);
insert into clientes (nome,sexo,id_carro) values ('Fernanda','F',4);
insert into clientes (nome,sexo,id_carro) values ('Daniela','F',8);
insert into clientes (nome,sexo,id_carro) values ('Igor','M',2);
insert into clientes (nome,sexo,id_carro) values ('Carol','F',7);
insert into clientes (nome,sexo,id_carro) values ('Ricardo','M',6);
insert into clientes (nome,sexo,id_carro) values ('Joao','M',9);

insert into telefone (tipo,numero,id_cliente) values ('cel','998345876',8);
insert into telefone (tipo,numero,id_cliente) values ('res','123456789',1);
insert into telefone (tipo,numero,id_cliente) values ('cel','999865447',3);
insert into telefone (tipo,numero,id_cliente) values ('com','234345766',2);
insert into telefone (tipo,numero,id_cliente) values ('cel','933545665',4);
insert into telefone (tipo,numero,id_cliente) values ('cel','921434343',6);
insert into telefone (tipo,numero,id_cliente) values ('com','827876576',10);
insert into telefone (tipo,numero,id_cliente) values ('res','123476654',5);
insert into telefone (tipo,numero,id_cliente) values ('cel','998769893',9);
insert into telefone (tipo,numero,id_cliente) values ('cel','998753832',7);
insert into telefone (tipo,numero,id_cliente) values ('res','344656332',6);
-------------------------------------------------------------------------------------------------------------------------------------------------------------------

-----------------------------------------------------------------------------------------------------------------------------------------------------------------
select c.nome, c.email, t.numero from cliente as c 
inner join telefone as t on t.id_cliente = c.idcliente
inner join endereco as e on e.id_cliente = c.idcliente 
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
select c.nome,c.sexo,ifnull(c.email,'sem email') as 'E-mail',t.tipo,t.numero,e.bairro,e.cidade,e.estado
...
select nome,sexo,cpf,cidade from cliente
...
insert into cursos (curso,horas,valor) values ('Banco de Dados Fundamnetal',25,200.00);
...
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Carlos','M', 10000.90,11000.80,12000.90);
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Maria','F', 13030.90,14030.80,10320.90);
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Antonio','M', 20000.90,1000.80,2000.90);
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Clara','F', 13040.90,10120.80,9000.90);
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Anderson','M', 19000.90,9040.80,12120.90);
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Ivone','F', 14060.90,11450.80,7890.90);
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Joao','M', 10001.90,11405.80,5003.90);
insert into vendedores( nome,sexo,janeiro,fevereiro,marco) values ('Celia','F', 16204.90,11033.80,17045.90);
...
select max(janeiro), min(janeiro), truncate(avg(janeiro),2) from vendedores;

select nome, janeiro from vendedores where janeiro = (select max(janeiro) from vendedores);
select nome, fevereiro from vendedores where fevereiro > (select avg(fevereiro) from vendedores);

select sum(janeiro) from vendedores;

select sexo, sum(janeiro) from vendedores
group by sexo;
...
(janeiro+fevereiro+marco) as 'total de vendas',
(janeiro+fevereiro+marco)*0.04 as 'comissão de vendas'
,(janeiro+fevereiro+marco)/3 as 'media de vendas' 
from vendedores;
...
insert into jogador (jogador) values ('guerrero');
insert into times (time,id_jogador) values ('flamengo',1);

-----------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------
\***{update e delete}\****
antes de executa-los dê um select no dado que vc quer apagar ou alterar!!!! Estando certo, pode continuar....
...
update jogador set jogador = 'diego' where idjogador = 1;
...
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('Cavaleiro Real','Ana Claudia','F',465,'Atlas',49.9,'RJ',2009);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('SQL para Leigos','João Nunes','M',450,'Addison',98,'SP',2018);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('Receitas Caseiras','Celia Tavares','F',210,'Atlas',45,'RJ',2008);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('Pessoas Efetivas','Eduardo Santos','M',390,'Beta',78.99,'RJ',2018);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('Habitos Saudáveis','Eduardo Santos','M',630,'Beta',150.98,'RJ',2019);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('A Casa Marrom','Hermes Macedo','M',250,'Bubba',60,'MG',2016);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('Estacio Querido','Geraldo Francisco','M',310,'Insignia',100,'ES',2015);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('Pra sempre amigas','Leda Silva','F',510,'Insignia',78.98,'ES',2011);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('Copas Inesqueciveis','Marco Alcantara','M',200,'Larson',130.98,'SP',2018);
insert into livros (nome,autor,sexo_autor,paginas,editora,valor,estado,ano) values ('O poder da mente','Clara Mafra','F',120,'Continental',56.58,'SP',2017);
...
select nome,estado from livros where sexo_autor = 'M';
select nome,paginas from livros where sexo_autor = 'F';
select valor from livros where estado = 'SP';
select * from livros where sexo_autor = 'M' and (estado = 'RJ' or estado = 'SP');
...
select nome,sexo,endereco from cliente where sexo = 'F' or endereco = 'RJ';
select nome,sexo,endereco from cliente where endereco = 'RJ' and sexo = 'F';
------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------
create database 1000_Dados;
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------------
select nome,sexo,salario,cargo
from funcionarios
where salario = (select max(salario) from funcionarios where sexo = 'Masculino');

select sexo,sum(salario)
from funcionarios
group by sexo;

select sexo,truncate(avg(salario),2)
from funcionarios
group by sexo;
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
select c.idcliente as 'id',c.nome,c.sexo,c.email,c.cpf,
...
inner join endereco e on c.idcliente = e.id_cliente
inner join telefone t on c.idcliente = t.id_cliente
where c.sexo = 'F' and e.bairro = 'Centro' and e.cidade = 'Rio de Janeiro' and tipo in ('res','com');


select c.nome,c.email,e.estado,t.numero,t.tipo
from cliente c 
inner join endereco e on c.idcliente = e.id_cliente
inner join telefone t on c.idcliente = t.id_cliente
...
select c.nome,ifnull(c.email,'Sem Email') as 'E-mail',e.estado,t.numero
from cliente c 
inner join endereco e on c.idcliente = e.id_cliente
inner join telefone t on c.idcliente = t.id_cliente;
----------------------------------------------------------------------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
***apagando e atualizando dados em views***

update VIEW_bericht set nome = 'José' where nome = 'Jorge';
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------
**FUNÇÕES DE AGREGAÇÃO NUMERICA**	*esta tabela está em projeto*
...
insert into vendedores values (null,'Carlos','M', 10000.90,11000.80,12000.90);
insert into vendedores values (null,'Maria','F', 13030.90,14030.80,10320.90);
insert into vendedores values (null,'Antonio','M', 20000.90,1000.80,2000.90);
insert into vendedores values (null,'Clara','F', 13040.90,10120.80,9000.90);
insert into vendedores values (null,'Anderson','M', 19000.90,9040.80,12120.90);
insert into vendedores values (null,'Ivone','F', 14060.90,11450.80,7890.90);
insert into vendedores values (null,'Joao','M', 10001.90,11405.80,5003.90);
insert into vendedores values (null,'Celia','F', 16204.90,11033.80,17045.90);

**FUNÇÃO MAX**
select max(fevereiro) as 'Maior Venda' 
from vendedores;

**FUNÇÃO MIN**
select min(fevereiro) as 'Menor Venda' 
from vendedores;

**FUNÇÃO MEDIA**
select avg(janeiro) as 'Media de Vendas'
from vendedores;

**TRUNCATE**

select truncate(avg(janeiro),2) as 'Media de Vendas'
from vendedores;


select nome,fevereiro as 'Maior Venda' 
from vendedores
...
select sum(janeiro) as 'Total de Vendas Janeiro'
from vendedores;

**VENDAS POR SEXO**

select sexo,sum(marco) as 'Total de Vendas'
from vendedores
group by sexo;
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
*****SUBQUERIES BANCO DE DADOS MAFRA********** 
...
select nome,sexo,marco
from vendedores
where marco = (select min(marco) from vendedores where sexo = 'F');
...
select nome,sexo,fevereiro
from vendedores
where fevereiro < (select avg(fevereiro) from vendedores);                     	(< SIMBOLO DE MENOR)   


select nome,sexo,fevereiro
from vendedores
where fevereiro > (select avg(fevereiro) from vendedores);                      	(> SIMBOLO DE MAIOR)   


MINHAS SUBQUERIES DE OUTRO CURSO

VIKINGS

select b.nome, b.altura, m.nome from bebes as b 
inner join maes as m on b.id_maes = m.id_maes
where b.altura = (select max(altura) from bebes where id_maes = 2);


select b.nome, b.altura, m.nome from bebes as b 
inner join maes as m on b.id_maes = m.id_maes
where b.altura in (select max(altura) from bebes group by id_maes);


select *from bebes 
where altura = (select max(altura) from bebes where id_maes = 2);


FARMACIA

select c.nome,p.produto,p.preco_venda,pv.quantidade,v.data,
(pv.quantidade*p.preco_venda) as 'Preço Total'
from produtos_vendas pv
inner join produtos p on p.codigo = pv.codigo_produtos
inner join vendas v on v.codigo = pv.codigo_vendas
inner join clientes c on c.codigo = v.codigo_cliente
where nome = 'Felicity Jones';


select c.nome,p.produto,p.preco_venda,pv.quantidade,v.data,
(pv.quantidade*p.preco_venda) as 'Preço Total',sum(pv.quantidade*p.preco_venda) as 'Valor total'
from produtos_vendas pv
inner join produtos p on p.codigo = pv.codigo_produtos
inner join vendas v on v.codigo = pv.codigo_vendas
inner join clientes c on c.codigo = v.codigo_cliente
...
select p.produto,p.preco_venda,tp.nome
from produtos p 
inner join tipos_produto tp on tp.codigo = codigo_tipos_produto
where preco_venda in (select max(preco_venda) from produtos group by codigo_tipos_produto);
...
inner join vendas v on v.codigo = pv.codigo_vendas
inner join clientes c on c.codigo = v.codigo_cliente
where quantidade = (select max(quantidade) from produtos_vendas);
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
**OPERAÇÕES EM LINHA**

select nome,janeiro,fevereiro,marco,
       (janeiro+fevereiro+marco) as 'Trimestre',
...
select nome,janeiro,fevereiro,marco,
       (janeiro+fevereiro+marco) as 'Trimestre',
       truncate((janeiro+fevereiro+marco)/3,2) as 'Média',
       (janeiro+fevereiro+marco) * 0.04 as 'Comissão'
from vendedores;  
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ALTERANDO TABELAS (USANDO O COMANDO ALTER) : USANDO O BANCO COMERCIO
...
---------------------------------------------------------------------------------------------------------------------------------------------
***alterando o nome da coluna com o change***

alter table produto
change preco valor_unitario int not null;
----------------------------------------------------------------------------------------------------------------------------------------------------------
***alterando o tipo de dado com o modify***

alter table produto
modify preco varchar(50) not null;
-----------------------------------------------------------------------------------------------------------------------------------------------------
****adicionando colunas***
...
insert into backup.backup_produto values (null,1000,'teste',0.0);
...
insert into produto values (null,'Livro Java',85.00);


alter table backup.backup_produto
add evento char(1);



drop trigger backup_produ;
drop trigger backup_prod_delete;
...
insert into vendedores values (null,'Gloria',554786,76889,7098);



select nome,
(jan+fev+marc) as 'Total' 
from vendedores;
...
create table medico(
idmedico idpaciente int primary key auto_increment,
nome varchar(30),
sexo char(1),
